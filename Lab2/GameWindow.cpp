...
HDC GameWindow::Init(HINSTANCE hinstance) 
{
	...
	CreateGameWindow("INM376 / IN3005 Computer Graphics Using OpenGL: Lab 2");
...
void GameWindow::CreateGameWindow(string sTitle) 
{
	...
	else m_hwnd = CreateWindowEx(0, m_sAppName.c_str(), sTitle.c_str(), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN,
